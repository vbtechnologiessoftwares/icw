...
<div class="container-fluid mt-3">
  <div class="row">
    <div class="col-sm-6">
    <center><img src="{{ asset('image/HEALTH-COVERAGE-PNG.png')}}" style="width:100%;"></center>
    </div>
    <div class="col-sm-6"><BR><br>
    <h1 class="aa d-lg-none">HEALTH COVERAGE</h1>
    <h1 class="aa d-none d-lg-block">HEALTH COVERAGE</h1>
  ...
  <div class="col">
   ...
   <div class="row g-3">
    ...
    <option value="MS">MS</option>
      ...
      <div class="row g-3">
    <div class="col">
   <label for="conf_password" class="col-lg-12 control-label">Student</label>
...
<div class="row g-3">
    <div class="col">
     <label for="relationship_to_applicant" class="col-lg-12 control-label">Current Coverage Type</label>
  ...
  <div class="row g-3">
    <div class="col">
     <label for="relationship_to_applicant" class="col-lg-12 control-label">Expiration Date</label>
         <input type="date" name="expiration_date" id="expiration_date" class="form-control" placeholder="Expiration Date" required>
  </div>
  <div class="col">

      <label for="relationship_to_applicant" class="col-lg-12 control-label">Insured Since</label>
          <input type="date" name="insured_since" id="insured_since" class="form-control" placeholder="Insured Since" required>
  </div>
